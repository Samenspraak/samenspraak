...
De prompt blijft vast; de LLM neemt woorden uit de input over om aandachtig en betrokken te blijven in toon.
...
Testresultaten worden vastgelegd volgens de structuur in [PROMPTS_GETTING_STARTED.md](PROMPTS_GETTING_STARTED.md#6-bevindingen-vastleggen).  
